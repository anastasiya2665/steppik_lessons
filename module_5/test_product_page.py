...
class TestProductPage():
    ...
    # def  test_guest_cant_see_success_message_after_adding_product_to_basket(self, browser, promo_number):
    #     promo_offer_r = int(promo_number)
    #     link = f"http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/?promo=offer{promo_offer_r}"
    #     item_page = ProductPage(browser, link, promo_number)
    #     item_page.open()
    #     item_page.add_to_basket()
    #     #item_page.solve_quiz_and_get_code()
    #     item_page.should_not_be_success_message()
